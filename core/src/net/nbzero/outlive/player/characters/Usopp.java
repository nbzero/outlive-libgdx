...
public class Usopp extends Character {
	...
	private static Sound skill1 = Gdx.audio.newSound(Gdx.files.internal("sound/SFX/Usopp_skill1_v2.mp3"));
	private static Sound skill2 = Gdx.audio.newSound(Gdx.files.internal("sound/SFX/Usopp_skill2.mp3"));
